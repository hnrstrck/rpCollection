...
\begin{figure*}[htb]
    \centering
    %\fbox{
     \subfloat[Anschluss des RGB-Scheinwerfers (Anschluss an ">IO02"<, ">IO03"<, ">IO04"< und ">GND"<).]{\includegraphics[width=7.5cm]{img/anschluss_rgb_led.PNG}}
     ~
       \subfloat[Anschluss eines Helligkeitssensors (Anschluss an ">IO03"<, ">3V3"< und ">GND"<).]{\includegraphics[width=7.5cm]{img/anschluss_phototransistor.PNG}}
    \caption{Angeschlossene Bauteile am Steckbrett.}
    \label{fig:objekterzeugung_bluej}
\end{figure*}
